...
?>
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/DeliveryModule">
				<i class="menu-icon fa fa-truck"></i>
				<span class="menu-text"> Delivery Module </span>
			</a>
			<b class="arrow"></b>
		</li>

		<!-- <li class="">
			<a href="<?php echo base_url(); ?>module/RepairModule">
				<i class="menu-icon fa fa-money"></i>
				<span class="menu-text"> Repair Module </span>
			</a>
			<b class="arrow"></b>
		</li> -->
...
<?php } elseif ($module == 'Administration') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			...
			|| array_search("subcategory", $access) > -1
...
<?php } elseif ($module == 'DeliveryModule') { ?>
	<ul class="nav nav-list">
		<li class="active">
			<a href="<?php echo base_url(); ?>module/dashboard">
				<i class="menu-icon fa fa-tachometer"></i>
		...
		<li>
			<a href="<?php echo base_url(); ?>module/DeliveryModule" class="module_title">
				<span>Delivery Module</span>
			</a>
		</li>
		<?php if (array_search("delivery_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>delivery_entry">
					<i class="menu-icon fa fa-shopping-cart"></i>
					<span class="menu-text"> Delivery Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		<?php if (array_search("delivery_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>delivery_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Delivery Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'RepairModule') { ?>
	<ul class="nav nav-list">
		...
		<li>
			<a href="<?php echo base_url(); ?>module/RepairModule" class="module_title">
		...
		<?php if (array_search("service", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>service">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> Repair Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("service_company", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>service_company">
					...
					<span class="menu-text"> Repair Company </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		<?php if (array_search("expense", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
		...
		<?php if (array_search("serviceRecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>serviceRecord">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Repair Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("serviceStock", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>serviceStock">
					...
					<span class="menu-text">Repair In Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("serviceOutStock", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>serviceOutStock">
					...
					<span class="menu-text"> Repair Out Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
