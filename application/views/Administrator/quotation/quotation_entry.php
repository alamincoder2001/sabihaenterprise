...
<script>
	...
	new Vue({
		...
		methods: {
			...
			// 	if (this.quotation.salesId != 0 && this.oldCustomerId != parseInt(this.selectedCustomer.Customer_SlNo)) {
			...
			// 			return;
			// 		}
			// 	} else if (this.quotation.salesId != 0 && this.oldCustomerId == parseInt(this.selectedCustomer.Customer_SlNo)) {
			// 		this.quotation.previousDue = this.oldPreviousDue;
			// 		return;
			// 	}
			...
			getQuotations() {
				axios.post('/get_quotations', {
					...
					this.quotation.salesType = quotation.SaleMaster_SaleType;
					...
					// let cus = this.customers.find(c => c.Customer_SlNo = quotation.SalseCustomer_IDNo)
					// console.log(cus);
