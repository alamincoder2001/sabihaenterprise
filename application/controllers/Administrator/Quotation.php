...
class Quotation extends CI_Controller
{
    ...
    public function deleteQuotation()
    {
        ...
        $data = json_decode($this->input->raw_input_stream);
        try {
            $this->db->where('SaleMaster_SlNo', $data->quotationId)->set('Status', 'd')->update('tbl_quotation_master');
            $this->db->where('SaleMaster_IDNo', $data->quotationId)->set('Status', 'd')->update('tbl_quotation_details');
