            ...
            <div id="invoiceContent">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <div _h098asdh>
                            {{sales.Status == 'a' ? 'Sales' : 'Order'}} Invoice
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-8">
                        <table id="tbl">
                            <tr>
                                <td style="width:23%">Customer Id</td>
                                <td style="padding: 0px 5px;width:5%;color:#000;font-weight:500">:</td>
                            ...
                            <tr>
                            <tr>
                                <td style="width:23%">Contact No.</td>
                                <td style="padding: 0px 5px;width:5%;color:#000;font-weight:500">:</td>
                    ...
                    <div class="col-xs-4">
                        <table id="tbl">
                            <tr>
                                <td>Invoice No.</td>
                                <td style="padding: 0px 5px;color:#000;font-weight:500">:</td>
                                <td style="text-align:right">{{ sales.SaleMaster_InvoiceNo }}</td>
                            <tr>
                            <tr>
                                <td>Sale Date</td>
                                <td style="padding: 0px 5px;color:#000;font-weight:500">:</td>
                                <td style="text-align:right">{{ sales.SaleMaster_SaleDate }} {{ sales.AddTime | formatDateTime('h:mm a') }}</td>
                            <tr>
                            <tr>
                                <td>{{sales.Status == 'a' ? 'Sales' : 'Order'}} By</td>
                                <td style="padding: 0px 5px;color:#000;font-weight:500">:</td>
                                <td style="text-align:right">{{ sales.AddBy }}</td>
                            <tr>
                        </table>
                    </div>
                </div>
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td width="18%">{{ product.warranty }}</td>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{ sales.service_charge }}</td>
                            </tr>
                            <tr>
                            ...
                            <table style="width:100%;">
                                <thead>
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div class="col-xs-2" style="padding:0"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:140px;width:220px" /></div>
                                                <div class="col-xs-10" style="padding-top:20px;">
                                                    <strong style="font-size:18px;">${this.currentBranch.Company_Name}</strong><br>
                                                    <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                                                </div>
