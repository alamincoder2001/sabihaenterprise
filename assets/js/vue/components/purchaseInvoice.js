                        ...
                        <table _a584de>
                            <thead>
                                <tr>
                                    ...
                                    <td>Unit</td>
                                    <td>Unit Price</td>
                                    <td style="display:none">Warranty Month</td>
                                    <td>Total</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td style="width:50%">{{ product.Product_Name }} <br>
                                        (<span  v-for="(Serial, ind) in product.serial">
                                    ...
                                    <td style="display:none">{{ product.warranty_month }}</td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <table class="pull-left">
                            ...
                            <tr v-if="purchase.is_customer == 1">
                                <td><strong>Total Due:</strong></td>
                                
                                <td v-if="Math.sign(purchase.previous_due) == 1" style="text-align:right">{{ (parseFloat(purchase.previous_due) - parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)).toFixed(2) }}</td>
                                <td v-else style="text-align:right">{{ (parseFloat(purchase.previous_due) + parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)).toFixed(2) }}</td>
                            </tr>
                            <tr v-else>
                                <td><strong>Total Due:</strong></td>
